  ...
  return (
    ...
    >
      <div className="flex min-h-screen items-center justify-center p-4">
        {/* Backdrop */}
        <div 
          className="fixed inset-0 bg-blue-950/90 backdrop-blur-sm transition-opacity"
          aria-hidden="true"
          onClick={onClose}
        ></div>
        ...
        {/* Modal panel */}
        <div 
          className="relative max-w-2xl w-full bg-gradient-to-b from-blue-900/90 to-purple-900/90 rounded-2xl border border-blue-700/50 shadow-xl transform transition-all animate-in fade-in slide-in-from-bottom-4"

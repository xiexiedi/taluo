...
export const JournalDetailModal: React.FC<JournalDetailModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="max-w-2xl w-full bg-gradient-to-b from-blue-900/90 to-purple-900/90 rounded-2xl border border-blue-700/50 shadow-xl animate-in fade-in slide-in-from-bottom-4"
